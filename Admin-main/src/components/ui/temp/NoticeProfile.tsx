...
const NoticeProfile: React.FC = () => {
  ...
  const [deleteIndex] = useState<any>(null);
  ...
  const [inputValue, setInputValue] = useState<TableDataType>({
    namePerson: "",
    title: "",
    contactInfo: "",
    image: "",
      ...
      <table className="border-gray-300 w-full border-collapse rounded-md border">
        ...
        <thead className=" font-bold">
          <tr className="w-14 bg-slate-200 text-black">
            ...
            <th className="border-gray-300 border p-2 text-sm">Notice Title</th>
            <th className="border-gray-300 border p-2 text-sm">Updated Date</th>
            <th className="border-gray-300 border p-2 text-sm">Status</th>
