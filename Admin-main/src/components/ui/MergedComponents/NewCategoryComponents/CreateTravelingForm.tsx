...
import { Traveling } from "@/redux/fetures/service/travelingSlice";
...
interface CreateTravelingFormProps {
    formData: Traveling;
    travelings: any[];
     onClose: () => void;
      onSave: () => void;
...
const CreateTravelingForm: React.FC<CreateTravelingFormProps> = ({
    formData,
    travelings,
     onClose,
  onSave,
  ...
  loading,
    ...
    const hiddenFileInput = useRef<HTMLInputElement>(null);
       ...
       const categories = Array.from(
         new Set(
           (travelings || []).map((item: any) => item.category).filter(Boolean)
         )
           ...
           <div className="w-[50%] h-[95%] bg-[#ccccff] p-8 rounded-lg shadow-lg ">
             ...
             <div className="mb-4 flex items-center justify-between">
               <div className="flex flex-row items-center">
                 <button
                   className={`${poppins.className} font-semibold text-base bg-[#ffb200] w-25 h-16 rounded-[8px] disabled:cursor-not-allowed  text-[#000000]`}
                   onClick={handleClick}
                   disabled={loading}
                 >
                    {loading ? (
                 ...
                 <div className="flex flex-col w-full ">
                   ...
                   <span className="flex flex-col">
                     ...
                     <input
                       ...
                       onChange={(e) => onFormChange("places", e.target.value)}
                       name="places"
                       id="places"
                     />
                   </span>
                   ...
                   <div className="flex flex-col">
                     ...
                     <CreatableSelect
                       ...
                       options={categories}
                       onChange={(option) =>
                         onFormChange("category", option ? option.value : "")
                       }
                       className="w-[300px]"
                     />
                   </div>
...
export default CreateTravelingForm; 