...
import { Construction } from "@/redux/fetures/service/constructionSlice";
...
const CreateConstructionForm: React.FC<CreateConstructionFormProps> = ({
  formData,
  construction,
   onClose,
  onSave,
  ...
  const editorRef = useRef(null);
     ...
     const categories = Array.from(
       new Set(
         (construction || []).map((item: any) => item.category).filter(Boolean)
       )
...
export default CreateConstructionForm;
