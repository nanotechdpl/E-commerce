...
import { Export } from "@/redux/fetures/service/exportSlice";
...
const CreateExportForm: React.FC<CreateExportFormProps> = ({
  formData,
  exportedData,
  onClose,
  onSave,
 ...
 const hiddenFileInput = useRef<HTMLInputElement>(null);
   ...
   const categories = Array.from(
     new Set(
       (exportedData || []).map((item: any) => item.category).filter(Boolean)
     )
