  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-270">
        ...
        <div className="rounded-sm h-[700px] border border-stroke bg-white shadow-default  ">
          ...
          <div className="p-7">
            <form action="#">
              ...
              <div
                id="FileUpload"
                className="bg-slate relative mb-5.5 block w-[500px] mx-auto cursor-pointer appearance-none rounded border border-dashed border-primary px-4 py-4  sm:py-7.5"
              >
                <input
                  type="file"
                  accept="image/*"
