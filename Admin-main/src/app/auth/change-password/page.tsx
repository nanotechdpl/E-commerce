...
function CreatePassword() {
  return (
    <>
      <header className="text-center 2xl:mb-[38px] mb-10 p-3">
        <div
        ...
        ></div>
        <h1 className="text-2xl text-left text-black font-extrabold lg:text-2xl 2xl:text-[40px] 2xl:leading-[54px] mb-[13px]">
          Enter New Password
        </h1>
      </header>
